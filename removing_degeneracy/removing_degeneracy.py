...
def local_qualities(N, local_i, local_i_offset, seed = None):
    return ((q_global[local_i_offset:local_i_offset + local_i]+(local_i + local_i_offset)/394353)/370)
...
qwoa.log_results("removing_degeneracy", "equal", action = "a")
