...
log = pd.read_csv('expectation_of_weighted_test_1.csv')
...
data = h5py.File('expectation_of_weighted_test_1.h5','r')
...
output.to_csv (r'quality_distributions_expectation_of_weighted_test_1.csv', index = True, header=True)
